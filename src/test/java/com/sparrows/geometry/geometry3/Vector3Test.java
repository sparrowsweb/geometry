...
class Vector3Test {
    ...
    @Test
    void TestXUnit() {
        checkVector3(Vector3.xUnit,1,0, 0);
    }

    @Test
    void TestYUnit() {
        checkVector3(Vector3.yUnit,0,1, 0);
    }

    @Test
    void TestZUnit() {
        checkVector3(Vector3.zUnit,0,0, 1);
    }
    ...
    @Test
    void TestCross() {
        checkVector3(Vector3.xUnit.cross(Vector3.yUnit),0,0,1);
        checkVector3(Vector3.yUnit.cross(Vector3.zUnit),1,0,0);
        checkVector3(Vector3.zUnit.cross(Vector3.xUnit),0,1,0);
        checkVector3(Vector3.xUnit.cross(Vector3.zUnit),0,-1,0);
        checkVector3(Vector3.yUnit.cross(Vector3.xUnit),0,0,-1);
        checkVector3(Vector3.zUnit.cross(Vector3.yUnit),-1,0,0);
        checkVector3(Vector3.xUnit.cross(Vector3.xUnit),0,0,0);
        checkVector3(Vector3.yUnit.cross(Vector3.yUnit),0,0,0);
        checkVector3(Vector3.zUnit.cross(Vector3.zUnit),0,0,0);
    }
    ...
    void TestRotateOriginXAxis() throws GeometryException {
        Vector3 v = new Vector3(1,2,3);
        Vector3 u = v.rotateOrigin(Vector3.xUnit, Maths.PI2);
    ...
    void TestRotateOriginYAxis() throws GeometryException {
        Vector3 v = new Vector3(1,2,3);
        Vector3 u = v.rotateOrigin(Vector3.yUnit, Maths.PI2);
    ...
    void TestRotateOriginZAxis() throws GeometryException {
        Vector3 v = new Vector3(1,2,3);
        Vector3 u = v.rotateOrigin(Vector3.zUnit, Maths.PI2);
